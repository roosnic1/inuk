            ...
            <div class="col-xs-8 col-xs-offset-2">
                ...
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4">
                        <img src="/_/img/stamp_sherpa.png" class="koProdImg" />
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <img src="/_/img/sherpa/img1.jpg" class="koProdImg" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5 col-xs-12 koDesc2">
                        ...
                        <table>
                          <tr>
                            <td><p>Grösse:</p></td>
                            <td><p>ca. 12cm lang, 3.5cm Durchmesser</p></td>
                          </tr>
                          <tr>
                            <td><p>Material:</p></td>
                            <td><p>Bambus</p></td>
                    ...
                    <div class="col-sm-7 col-xs-12">
                        <img src="/_/img/sherpa/img2.jpg" class="koProdImg" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <img src="/_/img/sherpa/img3.jpg" class="koProdImg" />
                    </div>
                    <div class="col-xs-12 visible-xs-block">
                        <div class="koProdBreak"></div>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <img src="/_/img/sherpa/img4.jpg" class="koProdImg" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <img src="/_/img/sherpa/img5.jpg" class="koProdImg" />
                    </div>
                </div>
